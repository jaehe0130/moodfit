...
# =========================
# 😄 Russell Circumplex 기반 감정 + 각성도(1~5) 매핑
# - 1: 매우 낮음(무기력/졸림)
# - 2: 낮음(차분/편안)
# - 3: 보통(중립/안정)
# - 4: 높음(긴장/흥분)
...
sh = get_spreadsheet()
ws = sh.worksheet("daily")  # daily 시트로 저장
...
# 보기 좋게 정렬 (가나다순)
all_emotions = sorted(list(EMOTION_AROUSAL.keys()))
